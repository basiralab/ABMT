...
class graph2graph(object):
    ...
    def train(self, args):
        ...
        second_counter = 0
        demo = str(input('Please specify training/ testing as follows:\n'
                         '00: No training / No testing\n'
                         '01: No training / Yes testing\n'
                         '10: Yes training / No testing\n'
                         '11: Yes training / Yes testing\n'
                         'Your response: ')
                   )
